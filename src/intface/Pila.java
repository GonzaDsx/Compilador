...
public class Pila<T> {
    ...
    public void mostrar() {
        if (estaVacia()) {
            ...
            //f.setSalida("La pila esta vacía");
            ...
            System.out.println("Pila1: "+datos);
            //showMessageDialog(null, "Pila show = "+ datos);
            //f.setElemento(datos+"");
            actual = null;
        }//else
    ...
    public void mostrar2() {
        if (estaVacia()) {
            ...
            System.out.println("Pila2: "+datos);
            //showMessageDialog(null, "Pila show = "+ datos);
            //f.setElemento(datos+"");
            actual = null;
        }//else
    ...
    public void push(T valor) {
        ...
        if (estaVacia()) {
            ...
            nuevo = new NodoG<T>(valor, tope);//El nuevo nodo ser� el primero
            //ini=nuevo;
        }
        tope = nuevo;
    ...
    public void pop() {
        ...
        if (estaVacia()) {
            ...
            //f.setSalida("Imposible eliminar, lista vacia");
        } else {
